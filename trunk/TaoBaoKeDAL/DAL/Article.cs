    ...
    public class TB_ArticleDal
    {
        ...
        public void Add(Shop.Model.TB_Article model)
        {
            ...
            OleDbParameter[] parameters = {
					...
					new OleDbParameter("@AddDate", SqlDbType.DateTime),
					new OleDbParameter("@CWRQ", SqlDbType.DateTime),
					new OleDbParameter("@FBRQ", SqlDbType.DateTime),
					new OleDbParameter("@ZRZ", OleDbType.VarChar,250),
					new OleDbParameter("@Content", SqlDbType.Text),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete TB_Article ");
            strSql.Append(" where QWBS=@QWBS ");
            OleDbParameter[] parameters = {
					new OleDbParameter("@QWBS", OleDbType.VarChar,50)};
        ...
        public Shop.Model.TB_Article GetModel(string QWBS)
        {
            ...
            Shop.Model.TB_Article model = new Shop.Model.TB_Article();
