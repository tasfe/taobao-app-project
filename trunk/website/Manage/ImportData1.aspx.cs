...
public partial class Manage_ImportData : System.Web.UI.Page
{
    ...
    {
        string numid = Request.QueryString["n"];
        string catId = Request.QueryString["c"];
        string topCatId = Request.QueryString["t"];
         string reason = Request.QueryString["r"];
         if (topCatId != null && topCatId != null && topCatId != null )
         {
             //Thread.Sleep(2000);
             string result = "";
             try
             {
                 ImprotTbk(numid, catId, topCatId, reason);
                 result = "<div class='c3'>" + DateTime.Now + " : " + "Successed..." + numid + "</div>";
             }
             catch (Exception ex)
             {
         ...
         else
         {
             ...
             //ddlColumn.DataSource = dtCol;
             //ddlColumn.DataTextField = "title";
             //ddlColumn.DataValueField = "ID";
    ...
    protected void ImprotTbk(string numiid,string catID,string topCatID,string itemImgs)
    {
        ...
        //{
            ...
            TaoBaoKe.ClickUrl = taobaokeItemDetail.ClickUrl;
            TaoBaoKe.Commission = 0;// taobaokeItemDetail.cCommission;
            ...
            TaoBaoKe.SellerCreditScore = taobaokeItemDetail.SellerCreditScore;
            TaoBaoKe.ShopClickUrl = taobaokeItemDetail.ShopClickUrl;
            TaoBaoKe.Title = taobaokeItemDetail.Item.Title;// taobaokeItemDetail.Item.Title;
    ...
    protected TaobaokeItem FilterItem(List<TaobaokeItem> taobaokeItems)
    {
        //TaobaokeItem taobaokeItem = null;
        //foreach (TaobaokeItem taobaokeItem1 in taobaokeItems.Content)
        //{
