<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportData1.aspx.cs" Inherits="Manage_ImportData" %>
...
<body>
    ...
    <div>
        <asp:DropDownList ID="ddlColumn" CssClass="column" runat="server">
        </asp:DropDownList>
        NumIid:<input id="numiid" />Tags:<input id="tags" />Reason:<input id="reason" />
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#save").click(function () {
                ...
                SendRequest(numiid, cat, tags, reason);
            })

            function SendRequest(key, catId, topCatId, reason) {
                SetInfo(Date() + " : " + "Requesting...   " + key + "</br>");
                $.ajax({
                    url: 'ImportData1.aspx',
                    data: 'n=' + encodeURI(key) + '&c=' + catId + '&t=' + topCatId + "&r=" + reason,
                    cache: false,
                    beforeSend: function () {
