...
public partial class pages_Default : UI.PageBase
{
    ...
    protected void DoAction()
    {
        ...
        if (!string.IsNullOrEmpty(action))
        {
            ...
            else if (action == "addweibo")
            {
                ...
                {
                    lblMsg.Text = "亲，你是免费的用户，只能添加两个帐号哦，点击右上角升级按钮升级吧，只要1毛一天哦：）";
                }
            }
    ...
    protected bool CheckTXKey()
    {
        ...
        {
            QQAPIUtil qqAPIUtil = new QQAPIUtil("", "", Util.XmlCOM.ReadConfig("TXCallbackUrl"));
    ...
    protected bool CheckSinaKey()
    {
        ...
        if (sian_key == null || string.IsNullOrEmpty(sian_key.ToString()))
        {
            ...
            sinaOauthTokenUrl = url + "&oauth_callback=" + Util.XmlCOM.ReadConfig("SinaCallbackUrl");
        }
        else
        {
            ret = true;
