...
namespace NetDimension.Weibo.Interface.Entity
{
	...
	public class SuggestionInterface: WeiboInterface
	{
		...
		/// <returns></returns>
		public IEnumerable<Entities.user.Entity> HotUsers(HotUserCatagory category )
		{
		...
		/// <returns></returns>
		public string MayInterestedUsers(int count, int page )
		{
		...
		/// <returns></returns>
		public IEnumerable<Entities.user.Entity> UsersByStatus(string content, int num )
		{
		...
		/// <returns></returns>
		public IEnumerable<Entities.status.Entity> HotStatuses(int type , bool isPic , int count, int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。 </param>
		/// <returns></returns>
		public IEnumerable<Entities.status.Entity> ReorderStatuses(int section, int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。 </param>
		/// <returns></returns>
		public Entities.status.IDs ReorderStatusIDs(int section, int count, int page )
		{
		...
		/// <param name="page"></param>
		/// <returns></returns>
		public IEnumerable<Entities.status.Entity> HotFavorites(int count , int page )
		{
