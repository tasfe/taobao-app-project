...
namespace NetDimension.Weibo.Interface.Entity
{
	...
	public class StatusInterface : WeiboInterface
	{
		...
		public Entities.status.Collection PublicTimeline(int count , int page, bool baseApp )
		{
		...
		/// <returns>dynamic json</returns>
		public Entities.status.Collection FriendsTimeline(string sinceID , string maxID , int count , int page , bool baseApp , int feature )
		{
		...
		/// <param name="feature">过滤类型ID，0：全部、1：原创、2：图片、3：视频、4：音乐，默认为0。 </param>
		/// <returns></returns>
		public Entities.status.Collection HomeTimeline(string sinceID , string maxID, int count , int page , bool baseApp , int feature )
		{
		...
		/// <param name="feature">过滤类型ID，0：全部、1：原创、2：图片、3：视频、4：音乐，默认为0。</param>
		/// <returns></returns>
		public Entities.status.IDs FriendsTimelineIDs(string sinceID , string maxID , int count, int page, bool baseApp , int feature)
		{
		...
		/// <returns></returns>
		public Entities.status.Collection UserTimeline(string uid, string screenName , string sinceID , string maxID , int count, int page, bool baseApp , int feature, bool trimUser)
		{
		...
		/// <param name="feature">过滤类型ID，0：全部、1：原创、2：图片、3：视频、4：音乐，默认为0。 </param>
		/// <returns></returns>
		public Entities.status.IDs UserTimelineIDs(string uid , string screenName , string sinceID , string maxID, int count , int page , bool baseApp , int feature )
		{
		...
		/// <returns></returns>
		public Entities.repost.Collection RepostTimeline(string id, string sinceID , string maxID , int count  , int page  , int filterByAuthor )
		{
		...
		/// <param name="filterByAuthor">作者筛选类型，0：全部、1：我关注的人、2：陌生人，默认为0。 </param>
		/// <returns></returns>
		public Entities.status.IDs RepostTimelineIDs(string id, string sinceID , string maxID , int count , int page , int filterByAuthor )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。 </param>
		/// <returns></returns>
		public Entities.status.Collection RepostByMe(string sinceID , string maxID , int count , int page )
		{
		...
		/// <returns></returns>
		public Entities.status.Collection Mentions(string sinceID , string maxID, int count , int page, int filterByAuthor , int filterBySource , int filterByType )
		{
		...
		/// <param name="filterByType">原创筛选类型，0：全部微博、1：原创的微博，默认为0。</param>
		/// <returns></returns>
		public Entities.status.IDs MentionIDs(string sinceID , string maxID , int count , int page , int filterByAuthor, int filterBySource , int filterByType )
		{
		...
		/// <param name="feature">过滤类型ID，0：全部、1：原创、2：图片、3：视频、4：音乐，默认为0。</param>
		/// <returns></returns>
		public Entities.status.Collection BilateralTimeline(string sinceID , string maxID, int count , int page , bool baseApp, int feature)
		{
		...
		/// <returns></returns>
		public string QueryMID(int type , string id)
		{
		...
		/// <param name="ids">需要查询的微博（评论、私信）ID</param>
		/// <returns></returns>
		public IEnumerable<string> QueryMID(int type, params string[] ids)
		{
		...
		/// <returns></returns>
		public string QueryID(int type , bool inbox , bool isBase62 , string mids)
		{
		...
		/// <param name="mids">需要查询的微博（评论、私信）MID，批量模式下，用半角逗号分隔，最多不超过20个。</param>
		/// <returns></returns>
		public IEnumerable<string> QueryID(int type , bool inbox , bool isBase62 , params string[] mids)
		{
		...
		/// <returns></returns>
		public IEnumerable<Entities.status.Entity> HotRepostDaily(int count , bool baseApp )
		{
		...
		/// <param name="baseApp"></param>
		/// <returns></returns>
		public IEnumerable<Entities.status.Entity> HotRepostWeekly(int count , bool baseApp)
		{
		...
		/// <param name="baseApp"></param>
		/// <returns></returns>
		public IEnumerable<Entities.status.Entity> HotCommentsDaily(int count , bool baseApp)
		{
		...
		/// <param name="baseApp"></param>
		/// <returns></returns>
		public IEnumerable<Entities.status.Entity> HotCommentsWeekly(int count , bool baseApp )
		{
		...
		/// <returns></returns>
		public Entities.status.Entity Update(string status, float lat, float log , string annotations )
		{
		...
		/// <param name="annotations">元数据，主要是为了方便第三方应用记录一些适合于自己使用的信息，每条微博可以包含一个或者多个元数据，必须以json字串的形式提交，字串长度不超过512个字符，具体内容可以自定。 </param>
		/// <returns></returns>
		public Entities.status.Entity Upload(string status, byte[] pic, float lat , float log , string annotations )
		{
		...
		/// <param name="annotations">元数据，主要是为了方便第三方应用记录一些适合于自己使用的信息，每条微博可以包含一个或者多个元数据，必须以json字串的形式提交，字串长度不超过512个字符，具体内容可以自定。 </param>
		/// <returns></returns>
		public Entities.status.Entity UploadUrlText(string status, string url, float lat , float log , string annotations )
		{
		...
		/// <returns></returns>
		public IEnumerable<Entities.status.Emotion> Emotions(EmotionType type , LanguageType language)
		{
