...
namespace NetDimension.Weibo.Interface.Entity
{
	...
	public class SearchInterface: WeiboInterface
	{
		...
		/// <returns></returns>
		public IEnumerable<Entities.search.User> Users(string q, int count )
		{
		...
		/// <param name="count">返回的记录条数，默认为10</param>
		/// <returns></returns>
		public IEnumerable<Entities.search.Status> Statuses(string q, int count )
		{
		...
		/// <returns></returns>
		public IEnumerable<Entities.search.School> Schools(string q, int count , int type )
		{
		...
		/// <param name="count">返回的记录条数，默认为10</param>
		/// <returns></returns>
		public IEnumerable<string> Companies(string q, int count )
		{
		...
		/// <param name="count">返回的记录条数，默认为10</param>
		/// <returns></returns>
		public IEnumerable<Entities.search.App> Apps(string q, int count )
		{
		...
		/// <returns></returns>
		public IEnumerable<Entities.search.AtUser> AtUsers(string q, int count , int type ,int range)
		{
		...
		/// <returns></returns>
		public Entities.status.Collection Topics(string q, int count , int page )
		{
