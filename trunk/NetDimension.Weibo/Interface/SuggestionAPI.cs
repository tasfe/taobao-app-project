...
namespace NetDimension.Weibo.Interface
{
	internal class SuggestionAPI: WeiboAPI
	{
		...
		/// <returns></returns>
		public string HotUsers(HotUserCatagory category )
		{
		...
		/// <returns></returns>
		public string UsersByStatus(string content, int num )
		{
		...
		/// <returns></returns>
		public string HotStatuses(int type , bool isPic , int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。 </param>
		/// <returns></returns>
		public string ReorderStatuses(int section, int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。 </param>
		/// <returns></returns>
		public string ReorderStatusIDs(int section, int count , int page )
		{
		...
		/// <param name="page"></param>
		/// <returns></returns>
		public string HotFavorites(int count , int page )
		{
