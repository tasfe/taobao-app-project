...
namespace NetDimension.Weibo.Interface
{
	internal class ShortUrlAPI: WeiboAPI
	{
		...
		/// <returns></returns>
		public string ShareStatuses(string urlShort, string sinceID , string maxID , int count , int page )
		{
			List<WeiboStringParameter> parameters = new List<WeiboStringParameter>();
		...
		/// <returns></returns>
		public string CommentComments(string urlShort, string sinceID , string maxID , int count, int page )
		{
			List<WeiboStringParameter> parameters = new List<WeiboStringParameter>();
			parameters.Add(new WeiboStringParameter("url_short", urlShort));
