<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AutoData.aspx.cs" Inherits="Manage_ImportData" %>
...
<body>
    ...
    <ul>
        ...
        <li>
            ...
            <%#Eval("title") %>
            <input type="text" id="txt<%#Eval("id")%>" class="<%#Eval("parentid") %>" value="<%#Eval("shortname") %>"/>
        </li>
        </ItemTemplate>
        </asp:Repeater>
    </ul>
