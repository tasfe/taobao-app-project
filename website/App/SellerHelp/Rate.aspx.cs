...
public partial class SellerHelp_Main : Shop.ShopUI.BasePage
{
    ...
    protected void BindProduct(int pageNo)
    {
        ...
        TradesSoldGetResponse tradesSoldGetResponse = ShopUtil.OpenTaobaoUtil.GetDefaultTopClient().Execute(tradesSoldGetRequest, GetSessionString("top_session"));
    ...
    protected string Rate()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                TraderateAddResponse traderateAddResponse = ShopUtil.OpenTaobaoUtil.GetDefaultTopClient().Execute(traderateAddRequest, GetSessionString("top_session"));
