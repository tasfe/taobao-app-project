...
namespace OAuthTXWeibo
{
    ...
    {
        static string  requestAuthorizeUrl = "https://open.t.qq.com/cgi-bin/oauth2/authorize?client_id={0}&response_type=code&redirect_uri={1}";
        static string requestAccessTokenUrl = "https://open.t.qq.com/cgi-bin/oauth2/access_token?client_id={0}&client_secret={1}&redirect_uri={2}&grant_type=authorization_code&code={3}";
        ...
        public static AccessToken GetAccessToken(string code, string client_id, string client_secret, string redirect_uri)
        {
