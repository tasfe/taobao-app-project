...
namespace SASCMS.BLL
{
	...
	{
        private readonly SASCMS.DAL.TB_ROLEDAL dal = new SASCMS.DAL.TB_ROLEDAL();
        public TB_ROLEBLL()
		{}
		#region  成员方法
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
        //public SASCMS.Model.TB_ROLE GetModelByCache(string RoleId)
        //{
        ...
        //        catch{}
        //    }
        //    return (SASCMS.Model.TB_ROLE)objModel;
        //}
