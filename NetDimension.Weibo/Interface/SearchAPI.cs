...
namespace NetDimension.Weibo.Interface
{
	internal class SearchAPI: WeiboAPI
	{
		...
		/// <returns></returns>
		public string Users(string q, int count )
		{
		...
		/// <param name="count">返回的记录条数，默认为10</param>
		/// <returns></returns>
		public string Statuses(string q, int count )
		{
		...
		/// <returns></returns>
		public string Schools(string q, int count , int type)
		{
		...
		/// <param name="count">返回的记录条数，默认为10</param>
		/// <returns></returns>
		public string Companies(string q, int count )
		{
		...
		/// <param name="count">返回的记录条数，默认为10</param>
		/// <returns></returns>
		public string Apps(string q, int count )
		{
		...
		/// <returns></returns>
		public string AtUsers(string q, int count , int type , int range )
		{
