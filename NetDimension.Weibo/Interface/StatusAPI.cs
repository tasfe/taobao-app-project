...
namespace NetDimension.Weibo.Interface
{
	internal class StatusAPI: WeiboAPI
	{
		...
		public string PublicTimeline(int count , int page , bool baseApp )
		{
		...
		/// <returns>dynamic json</returns>
		public string FriendsTimeline(string sinceID , string maxID , int count , int page, bool baseApp , int feature )
		{
		...
		/// <param name="feature">过滤类型ID，0：全部、1：原创、2：图片、3：视频、4：音乐，默认为0。 </param>
		/// <returns></returns>
		public string HomeTimeline(string sinceID , string maxID, int count, int page , bool baseApp , int feature)
		{
		...
		/// <param name="feature">过滤类型ID，0：全部、1：原创、2：图片、3：视频、4：音乐，默认为0。</param>
		/// <returns></returns>
		public string FriendsTimelineIDs(string sinceID , string maxID , int count , int page, bool baseApp, int feature)
		{
		...
		/// <returns></returns>
		public string UserTimeline(string uid , string screenName , string sinceID, string maxID , int count , int page, bool baseApp , int feature , bool trimUser )
		{
		...
		/// <param name="feature">过滤类型ID，0：全部、1：原创、2：图片、3：视频、4：音乐，默认为0。 </param>
		/// <returns></returns>
		public string UserTimelineIDs(string uid , string screenName, string sinceID , string maxID , int count , int page , bool baseApp , int feature )
		{
		...
		/// <returns></returns>
		public string RepostTimeline(string id, string sinceID , string maxID , int count , int page , int filterByAuthor )
		{
		...
		/// <param name="filterByAuthor">作者筛选类型，0：全部、1：我关注的人、2：陌生人，默认为0。 </param>
		/// <returns></returns>
		public string RepostTimelineIDs(string id, string sinceID , string maxID , int count , int page , int filterByAuthor)
		{
		...
		/// <param name="page">返回结果的页码，默认为1。 </param>
		/// <returns></returns>
		public string RepostByMe(string sinceID , string maxID , int count , int page )
		{
		...
		/// <returns></returns>
		public string Mentions(string sinceID , string maxID , int count , int page , int filterByAuthor , int filterBySource, int filterByType )
		{
		...
		/// <param name="filterByType">原创筛选类型，0：全部微博、1：原创的微博，默认为0。</param>
		/// <returns></returns>
		public string MentionIDs(string sinceID , string maxID , int count, int page , int filterByAuthor, int filterBySource , int filterByType )
		{
		...
		/// <param name="feature">过滤类型ID，0：全部、1：原创、2：图片、3：视频、4：音乐，默认为0。</param>
		/// <returns></returns>
		public string BilateralTimeline(string sinceID , string maxID , int count, int page, bool baseApp, int feature )
		{
		...
		/// <returns></returns>
		public string QueryMID(int type, params string[] ids)
		{
		...
		/// <returns></returns>
		public string QueryID(int type , bool inbox , bool isBase62 , params string[] mids)
		{
		...
		/// <returns></returns>
		public string HotRepostDaily(int count, bool baseApp )
		{
		...
		/// <param name="baseApp"></param>
		/// <returns></returns>
		public string HotRepostWeekly(int count , bool baseApp )
		{
		...
		/// <param name="baseApp"></param>
		/// <returns></returns>
		public string HotCommentsDaily(int count , bool baseApp )
		{
		...
		/// <param name="baseApp"></param>
		/// <returns></returns>
		public string HotCommentsWeekly(int count, bool baseApp)
		{
		...
		/// <returns></returns>
		public string Update(string status, float lat , float log , string annotations )
		{
		...
		/// <param name="annotations">元数据，主要是为了方便第三方应用记录一些适合于自己使用的信息，每条微博可以包含一个或者多个元数据，必须以json字串的形式提交，字串长度不超过512个字符，具体内容可以自定。 </param>
		/// <returns></returns>
		public string Upload(string status, byte[] pic, float lat , float log , string annotations )
		{
		...
		/// <param name="annotations">元数据，主要是为了方便第三方应用记录一些适合于自己使用的信息，每条微博可以包含一个或者多个元数据，必须以json字串的形式提交，字串长度不超过512个字符，具体内容可以自定。 </param>
		/// <returns></returns>
		public string UploadUrlText(string status, string url, float lat , float log , string annotations )
		{
