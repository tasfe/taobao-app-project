...
namespace NetDimension.Weibo.Interface
{
	internal class FavoriteAPI: WeiboAPI
	{
		...
		/// <returns></returns>
		public string Favorites(int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。 </param>
		/// <returns></returns>
		public string FavoriteIDs(int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。</param>
		/// <returns></returns>
		public string ByTags(string tid, int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。</param>
		/// <returns></returns>
		public string Tags(int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。</param>
		/// <returns></returns>
		public string ByTagIDs(string tid, int count , int page )
		{
