...
namespace NetDimension.Weibo.Interface
{
	...
	internal class LocationAPI:WeiboAPI
	{
		...
		public string GetMapImage(string center, string city, string coordinates , string names , string offsetX , string offsetY , string font , string lines , string polygons , string size , string format , string zoom , bool scale , bool traffic )
		{
		...
		public string SearchPOIsByLocation(string q , string category , string city , int page , int count )
		{
		...
		public string SearchPOIsByGeo(string q , string category , string coordinate ,string pid, string city,int range, int page , int count )
		{
		...
		public string SearchPOIsByArea(string q , string category, string coordinates , string city , int page , int count )
		{
			return Client.GetCommand("location/pois/search/by_geo",
				new WeiboStringParameter("q", q),
				new WeiboStringParameter("category", category),
		...
		public string DriveRouteLine(string beginPID , string beginCoordinate , string endPID , string endCoordinate , int type )
		{
		...
		public string BusRouteLine(string beginPID , string beginCoordinate , string endPID , string endCoordinate , int type )
		{
		...
		public string BusLine(string q, string city, int page, int count )
		{
		...
		public string BusStation(string q, string city , int page, int count )
		{
