...
namespace NetDimension.Weibo.Interface
{
	internal class FriendshipAPI: WeiboAPI
	{
		...
		/// <returns></returns>
		public string Friends(string uid , string screenName , int count , int cursor , bool trimStatus)
		{
		...
		/// <param name="cursor">返回结果的游标，下一页用返回值里的next_cursor，上一页用previous_cursor，默认为0。</param>
		/// <returns></returns>
		public string FriendIDs(string uid , string screenName , int count , int cursor )
		{
		...
		/// <returns></returns>
		public string FriendsInCommon(string uid , string suid, int count , int page )
		{
		...
		/// <returns></returns>
		public string FriendsOnBilateral(string uid, int count , int page , bool sort )
		{
		...
		/// <param name="sort">排序类型，0：按关注时间最近排序，默认为0。 </param>
		/// <returns></returns>
		public string FriendsOnBilateralIDs(string uid, int count , int page , bool sort )
		{
		...
		/// <param name="cursor">返回结果的游标，下一页用返回值里的next_cursor，上一页用previous_cursor，默认为0。</param>
		/// <returns></returns>
		public string Followers(string uid , string screenName , int count, int cursor,bool trimStatus)
		{
		...
		/// <param name="cursor">返回结果的游标，下一页用返回值里的next_cursor，上一页用previous_cursor，默认为0。 </param>
		/// <returns></returns>
		public string FollowerIDs(string uid , string screenName , int count, int cursor )
		{
		...
		/// <returns></returns>
		public string FollowersInActive(string uid, int count )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。</param>
		/// <returns></returns>
		public string FriendsChain(string uid, int count , int page )
		{
