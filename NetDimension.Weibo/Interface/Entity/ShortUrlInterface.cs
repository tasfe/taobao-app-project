...
namespace NetDimension.Weibo.Interface.Entity
{
	...
	public class ShortUrlInterface: WeiboInterface
	{
		...
		/// <returns></returns>
		public Entities.shortUrl.ShareStatuses ShareStatuses(string urlShort, string sinceID , string maxID , int count , int page )
		{
		...
		/// <returns></returns>
		public Entities.shortUrl.CommentComments CommentComments(string urlShort, string sinceID , string maxID , int count , int page )
		{
