...
namespace NetDimension.Weibo.Interface.Entity
{
	...
	public class TrendInterface: WeiboInterface
	{
		...
		/// <returns></returns>
		public IEnumerable<Entities.trend.Trend> Trends(string uid, int count , int page )
		{
		...
		/// <returns></returns>
		public Entities.trend.HotTrends Hourly(bool baseApp )
		{
		...
		/// <param name="base_app">是否基于当前应用来获取数据。true表示基于当前应用来获取数据。 </param>
		/// <returns></returns>
		public Entities.trend.HotTrends Daily(bool baseApp )
		{
		...
		/// <param name="base_app">是否基于当前应用来获取数据。true表示基于当前应用来获取数据。 </param>
		/// <returns></returns>
		public Entities.trend.HotTrends Weekly(bool baseApp )
		{
