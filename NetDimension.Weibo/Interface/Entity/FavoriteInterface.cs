...
namespace NetDimension.Weibo.Interface.Entity
{
	...
	public class FavoriteInterface: WeiboInterface
	{
		...
		/// <returns></returns>
		public NetDimension.Weibo.Entities.favorite.Collection Favorites(int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。 </param>
		/// <returns></returns>
		public NetDimension.Weibo.Entities.favorite.IDCollection FavoriteIDs(int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。</param>
		/// <returns></returns>
		public NetDimension.Weibo.Entities.favorite.Collection ByTags(string tid, int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。</param>
		/// <returns></returns>
		public IEnumerable<NetDimension.Weibo.Entities.favorite.TagEntity> Tags(int count , int page )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。</param>
		/// <returns></returns>
		public IEnumerable<NetDimension.Weibo.Entities.favorite.IDEntity> ByTagIDs(string tid, int count, int page )
		{
