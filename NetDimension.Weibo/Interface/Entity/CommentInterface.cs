...
namespace NetDimension.Weibo.Interface.Entity
{
	...
	public class CommentInterface : WeiboInterface
	{
		...
		public NetDimension.Weibo.Entities.comment.Collection Show(string id, string sinceID , string maxID , int count , int page , int filterByAuthor )
		{
		...
		/// <returns></returns>
		public NetDimension.Weibo.Entities.comment.Collection ByMe(string sinceID , string maxID , int count , int page, int filterBySource )
		{
		...
		/// <returns></returns>
		public NetDimension.Weibo.Entities.comment.Collection ToMe(string sinceID , string maxID , int count , int page , int filterByAuthor, int filterBySource )
		{
		...
		/// <param name="page">返回结果的页码，默认为1。 </param>
		/// <returns>JSON</returns>
		public NetDimension.Weibo.Entities.comment.Collection Timeline(string sinceID , string maxID , int count , int page)
		{
		...
		/// <param name="filterBySource">来源筛选类型，0：全部、1：来自微博的评论、2：来自微群的评论，默认为0。</param>
		/// <returns></returns>
		public NetDimension.Weibo.Entities.comment.Collection Mentions(string sinceID , string maxID , int count, int page , int filterByAuthor , int filterBySource )
		{
		...
		/// <returns></returns>
		public NetDimension.Weibo.Entities.comment.Entity Create(string id, string comment, bool commentOrigin )
		{
		...
		/// <param name="commentOrigin">当评论转发微博时，是否评论给原微博，0：否、1：是，默认为0。 </param>
		/// <returns></returns>
		public NetDimension.Weibo.Entities.comment.Entity Reply(string cid, string id, string comment, bool withoutMention , bool commentOrigin )
		{
