<%@ Page Title="" Language="C#" MasterPageFile="~/app/SellerMail/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Main.aspx.cs" Inherits="SellerHelp_Main" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    淘翻天卖家助手_进阶版订购：<br />
    1个月：￥5，<a href="http://fuwu.taobao.com/item/subsc.htm?items=ts-13815-4:1"  target="_blank">订购</a><br />
    3个月：￥12，<a href="http://fuwu.taobao.com/item/subsc.htm?items=ts-13815-4:3"  target="_blank">订购</a><br />
    6个月：￥22，<a href="http://fuwu.taobao.com/item/subsc.htm?items=ts-13815-4:6"  target="_blank">订购</a><br />
    12个月：￥40<a href="http://fuwu.taobao.com/item/subsc.htm?items=ts-13815-4:12"  target="_blank">订购</a>
    </div>
    <div class="category">
    ...
    <div class="right">
    <div class="listpage">
    <h2 class="hbline hbline1"><strong>第一步：选择要发推广邮件的老客户</strong></h2>
    <div id="search">
        ...
        <input type='button' value='下一步->选择要推广的宝贝' class='btn-mail'/>
            ...
            <ItemTemplate>
                <li>
                <div class="item-t">
                <input  type="checkbox" class="chk-item"  value="<%#Eval("tid")%>" /> 
                <%#Container.ItemIndex+1%>. 
                
                 旺旺：<%#Eval("buyernick")%><a  target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&uid=<%#Eval("buyernick")%>&site=cntaobao&s=1&charset=utf-8" ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<%#Eval("buyernick")%>&site=cntaobao&s=1&charset=utf-8" alt="点击这里给我发消息" /></a>
                 购买时间：<%#Eval("created")%> 
                 付款金额：<%#Eval("payment")%> 
